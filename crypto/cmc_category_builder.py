...
# Файлы данных
category_file = os.path.join(os.getenv("DATA_DIR", "data"), "category_tokens_details_2.xlsx")
result_files = [
    os.path.join(os.getenv("DATA_DIR", "data"), "result_2024-12-08_to_2024-12-09.xlsx"),
    os.path.join(os.getenv("DATA_DIR", "data"), "result_2024-12-15_to_2024-12-16.xlsx"),
    os.path.join(os.getenv("DATA_DIR", "data"), "result_2024-12-22_to_2024-12-23.xlsx"),
    os.path.join(os.getenv("DATA_DIR", "data"), "result_2024-12-29_to_2024-12-30.xlsx"),
    os.path.join(os.getenv("DATA_DIR", "data"), "result_2025-01-05_to_2025-01-06.xlsx"),
    os.path.join(os.getenv("DATA_DIR", "data"), "result_2025-01-12_to_2025-01-13.xlsx"),
    os.path.join(os.getenv("DATA_DIR", "data"), "result_2025-01-18_to_2025-01-19.xlsx")
]
...
output_file = os.path.join(os.getenv("DATA_DIR", "data"), "balanced_data_output_avg.xlsx")
